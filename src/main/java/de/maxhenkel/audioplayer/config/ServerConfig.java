...
public class ServerConfig {
        ...
        public final ConfigEntry<Integer> maxConcurrentTranscodes;
        ...
        public ServerConfig(ConfigBuilder builder) {
                ...
                ffmpegPath = builder.stringEntry(
                                ...
                                "If left empty, the mod will try to find ffmpeg in the system path");
                maxConcurrentTranscodes = builder.integerEntry(
                                "max_concurrent_transcodes",
                                2,
                                1,
                                Integer.MAX_VALUE,
                                "The maximum amount of concurrent ffmpeg transcodes");
        }
