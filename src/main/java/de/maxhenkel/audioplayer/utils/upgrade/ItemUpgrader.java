...
public class ItemUpgrader {
    ...
    private static final Identifier RANDOM_PLAYBACK_MODULE = Identifier.fromNamespaceAndPath("audioplayer_roleplay", "rng_playback");
    private static final Identifier STATIC_PLAYBACK_MODULE = Identifier.fromNamespaceAndPath("audioplayer_roleplay", "static");
